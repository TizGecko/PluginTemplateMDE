...
public class TestPackageImpl extends EPackageImpl implements TestPackage {
	 ...
	 */
	@Override
	public EAttribute getC1_Nome() {
		return (EAttribute)c1EClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getRoot_List() {
	...
	public void createPackageContents() {
		...
		createEAttribute(c1EClass, C1__NOME);

		rootEClass = createEClass(ROOT);
		createEReference(rootEClass, ROOT__LIST);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(c1EClass, test.C1.class, "C1", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getC1_Nome(), ecorePackage.getEString(), "nome", null, 0, 1, test.C1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(rootEClass, Root.class, "Root", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRoot_List(), this.getC1(), null, "list", null, 0, -1, Root.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
